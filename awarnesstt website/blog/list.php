  ...
  <head>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="#" class="active">בלוג</a></li>
    ...
    <!-- ***** Tipol main header Start ***** -->
        <div class="tipol-area" id="welcome">
            <div class="position-relative w-100 h-100" style="min-height: 400px; background-image: url(../assets/images/img1.jpg); background-position: center; background-size: cover;">
                ...
                <div class="container">
                    <div class="row">
                        <div class="offset-xl-3 col-xl-12 offset-lg-2 col-lg-12 col-md-12 col-sm-12">
                            ...
                            <li><a href="#blogs-section" class="fa fa-angle-double-down mt-2" style="font-size: 30px; color: #fff;"></a></li>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- ***** blogs page Small Start ***** -->
    <section class="section blogs-feature" id="blogs-section">
        <div class="container-fluid">
            <div class="row">
                <!-- ***** post Small Item Start ***** -->
                <div class="col-lg-12 col-md-12 col-sm-12 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                    <div class="blogs-small-item">
                      <div class="row">
                    <?php
                    ...
                    ?>
                        <div class="col-lg-3 col-md-6 col-sm-12 moreBox" style="display: none;">
                            <div class="blog-post-thumb" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                                <div class="position-relative h-100" style="min-height: 400px; background-image: url(../assets/images/<?php echo $row['image'] ?>); background-position: center; background-size: cover;">
                                    ...
                                    <h2 class="h6">
                                    <a href="article.php?mA33f4dItK=<?php echo $row['id']; ?>" class="text-white d-block text-right" style="font-size:1.5rem; line-height: 1.6; background:transparent; border-color:transparent;">
                                        <?php echo $row['title'] ?>
                                    </a> 
                                    </div>
                  ...
                  ?>      
                        ...
                        <div id="loadMore">
                        <button class="btn-loadmore">לעוד לחצו כאן</button>
                        </div>
                    </div>
                </div>
                <!-- ***** post Small Item End ***** -->
    ...
    <script>
        // Blog main page load more button ** START **
        $(function(){
        
        var loadingbtn = document.querySelector('.btn-loadmore');
        
        loadingbtn.addEventListener("click", function() {
        loadingbtn.innerHTML = "לעוד לחצו כאן";
    ...
    // Blog main page load more button ** END **
    </script>
  </body>
</html>